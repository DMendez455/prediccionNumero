...
// Rellena superficie con blanco para que el modelo reciba fondo limpio
 ...
 * y lo escala a 28x28, el formato de entrada que espera el modelo MNIST.
 */
...
analyzeButton.addEventListener('click', () => {
    ...
    tf.tidy(() => {
        // Convierte a escala de grises, invierte colores
        // MNIST: fondo negro, trazo blanco
        ...
        inputTensor = tf.where(
            inputTensor.greater(noiseFloor),
            inputTensor,
            tf.zerosLike(inputTensor)
        );
